...
namespace sim {
    ...
    for (int atom = 0; atom < num_atoms; ++atom) {
        ...
        y_pred_storage[atom] = Euler_step(spinDynamics, y, H, mp::dt, k1_storage[atom]);
    ...
    for (int atom = 0; atom < num_atoms; ++atom) {
        ...
        std::vector<double> y_next = Heun_step(spinDynamics, y_in_storage[atom], y_pred_storage[atom], H, mp::dt, k1_storage[atom]);
        ...
        // if (atom == 0) {
        //     std::cout << "After Heun step for atom 0: ";
        //     std::cout << "V_x: " << y_next[3] << " V_y: " << y_next[4] << " V_z: " << y_next[5] << std::endl;
        //     std::cout << "W_x: " << y_next[6] << " W_y: " << y_next[7] << " W_z: " << y_next[8] << std::endl;
        // }
